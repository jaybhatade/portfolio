  ...
  return (
    <div className="w-100 h-fit flex justify-center items-center text-white py-10">
      <div className="w-[100%] h-fit max-w-[1240px] flex flex-col justify-center items-center">
        <h2 className="text-3xl font-bold p-10">Get in Touch</h2>

        <div className="w-[100%] flex flex-row">
          <div className="w-[50%] p-8 rounded-l-2xl flex flex-col justify-between bg-zinc-700">
          ...
          <div className="w-[50%] h-fit p-8 px-10 rounded-r-2xl bg-slate-700 ">
            <div className="bg-white rounded-3xl w-[100%]  h-[100%] text-black p-8">
                <form action="" method="post">
                
                <label className="text-md font-semibold" htmlFor="name">Your Name</label> <br />
                <input className="w-[100%] h-10  mb-8 rounded-lg pl-2  transition-all duration-400 ease-in-out border-2 border-transparent focus:outline-teal-500 border-b-teal-500" type="text" placeholder="John William"/>
                

                
                <label className="text-md font-semibold" htmlFor="email">Email</label> <br />
                <input className="w-[100%] h-10 mb-8 rounded-lg pl-2  transition-all duration-400 ease-in-out border-2 border-transparent focus:outline-teal-500 border-b-teal-500" type="text" placeholder="abc@gmail.com"/>
                
                

                <label className="text-md font-semibold" htmlFor="email">Subject</label> <br />
                <input className="w-[100%] h-10  mb-8 rounded-lg pl-2  transition-all duration-400 ease-in-out border-2 border-transparent focus:outline-teal-500 border-b-teal-500" type="text" placeholder="Write your subject"/>
                

                
                <label className="text-md font-semibold" htmlFor="email">Message</label> <br />
                <input className="w-[100%] h-10  mb-8 rounded-lg pl-2  transition-all duration-400 ease-in-out border-2 border-transparent focus:outline-teal-500 border-b-teal-500" type="text" placeholder="Write message"/>
