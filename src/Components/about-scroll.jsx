...
function AboutScroll() {
  return (
    <div className="w-100 h-fit relative">
      ...
      <div className="w-100 h-fit py-[50px] bg-black text-white flex md:flex-row flex-col">
        
        <div className="md:w-[35%] w-[100%] pl-8 pt-4 md:p-8 md:pl-16 rounded-3xl ">
          <h1 className="md:text-[55px] text-[40px] font-bold uppercase w-fit h-fit">About Me :</h1>
        </div>
        <div className="md:w-[65%] w-[100%] p-8 md:pr-20">
